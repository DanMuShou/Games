...
public partial class EnableLevelComponent : VBoxContainer
{
    ...
    public void Init(string labelName, (int min, int max, int curLevel) levelRange)
    {
        ...
        if ((int)_levelSlider.Value != levelRange.curLevel)
            _levelSlider.Value = levelRange.curLevel;
